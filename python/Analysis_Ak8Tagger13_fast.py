...
class Analysis_Ak8Tagger(Handler):
	...
	def ApplyAK8Selection13(self, h_vetomap  ):

		#self.vetomap = h_vetomap 
		#self.rdframe.DefinePerSample("VetoMap", 'rdfsampleinfo_.GetD("h_vetomap")')
		...
		bool noMuon(ROOT::VecOps::RVec<double> &Muon_pt, ROOT::VecOps::RVec<double> &Muon_eta, ROOT::VecOps::RVec<double> &Muon_Iso, ROOT::VecOps::RVec<bool> &Muon_PassLooseID){
			...
			return noMuon;
                ...
                bool JetVetoMaps(ROOT::VecOps::RVec<float> &AK4_eta, ROOT::VecOps::RVec<float> &AK4_phi,ROOT::VecOps::RVec<bool> &AK4_isloose ,bool ispreEE, TH2D Map){
		...
		self.rdframe = self.rdframe.Filter("TriggerMatch(Trigger_hltname,Trigger_hltdecision)","TriggerMatch")\
                .Filter("!(JetVetoMaps(AK4PuppiJets_eta, AK4PuppiJets_phi, AK4PuppiJets_isloose, ispreEE, h_vetomap ))","JetVetoMap_selection")\
		...
		.Define("AK8_sdmJet1","AK8PuppiJets_softdropmass[ptIndex[1]]")\
                .Filter("noBtagAK4(AK4PuppiJets_pt,AK4PuppiJets_eta,AK4PuppiJets_phi,jet_pfDeepJetAK4JetTags_probb,jet_pfDeepJetAK4JetTags_probb,jet_pfDeepJetAK4JetTags_problepb,AK8_etaJet0,AK8_phiJet0,ispreEE)","BtagAK4Veto")\
