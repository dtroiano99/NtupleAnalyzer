...
void makeDC_PN(int bin = 0){
  ...
  TFile *outFile;
  std::string rootstring{"/lustre/home/dtroiano1/CMSSW_10_6_12/src/Zqq/NtupleAnalyzer/Utilities/corrected_likelihood/70_126_GeV/rootfiles/Bin"+std::to_string(bin)+".root"};
