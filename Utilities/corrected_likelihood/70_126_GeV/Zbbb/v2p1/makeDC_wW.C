...
void makeDC_PN(int bin = 0){
  cout<<bin<<endl;
  TFile *outFile;
  std::string rootstring{"/lustre/home/dtroiano1/CMSSW_10_6_12/src/Zqq/NtupleAnalyzer/Utilities/corrected_likelihood/70_126_GeV/Zbbb/v2p1/rootfiles/Bin"+std::to_string(bin)+"_wW.root"};
  ...
  TFile *f2;
  f2 = TFile::Open("../../wind_syst/v2/QCD.root","read");
  ...
  cout<<"rms: +"<<QCD_rmsup->Integral(1,QCD_rmsup->GetNbinsX())-QCDI<<endl;
  */
  

  //TFile *f4;
  //f4 = TFile::Open("../../wind_syst/rootfiles/window.root","read");
  ...
  datacard << left<< setw(20) << "lumi"<< setw(15) <<"lnN"<< setw(15)<< "1.022"<< setw(15) <<"1.022"<< setw(15)<<"1.022"<< setw(15) << "-" << setw(15)<<"1.022" << endl; 
