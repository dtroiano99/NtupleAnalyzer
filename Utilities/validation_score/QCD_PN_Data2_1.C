...
static const std::vector<float> PN_scores0 {0.768733,0.885883,0.936303, 0.961613,0.977057,0.986697,0.992354,0.996177, 1};

static const std::vector<float> PN_scores {0.768733,0.936303, 0.977057,0.992354, 1};

int PN_DIM =  PN_scores.size()-1; //number of PN-MD score bins

static const std::vector<vector<int>> idx 
{{3,4,1,1},//indexes of Polynomials
    {3,4,1,1},//indexes of Cebysev polynomials    
      {2,2,1,1}}; //indexes of DF
...
void QCD_PN_Data2_1(){
  ...
  */ 
  ...
  TString fname= "./Plots/comparison_PN2_1.pdf";
  auto canv = new TCanvas("Canvas", "Canvas", 1500, 600);  
  canv->cd();
  canv->Print(fname+"[");
  ...
  for(int j=0; j<functions.size();j++){
    ...
    for(int i=0;i<PN_DIM;i++){   
      ...
      std::string filestring{"./rootfiles_1/PN_"+ functions.at(j)+"2.root"};
  ...
  TString fname1= "./Plots/PNScore2_1.pdf";
