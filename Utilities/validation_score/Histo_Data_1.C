...
void Histo_Data_1(){
  ...
  for (int i = 0; i < nentries; i++){      
    ...
    for(int iPN=0; iPN<PN_DIM;iPN++){
      if(sdm_Higher_PN_MD_XbbVsQCD>l && sdm_Higher_PN_MD_XbbVsQCD<u && Higher_PN_MD_XbbVsQCD>PN_scores.at(iPN) && Higher_PN_MD_XbbVsQCD<=PN_scores.at(iPN+1))	{
	PN_Data_s[iPN]->Fill(sdm_Higher_PN_MD_XbbVsQCD/s);
      }
      if(((sdm_Higher_PN_MD_XbbVsQCD>Start && sdm_Higher_PN_MD_XbbVsQCD<l) || (sdm_Higher_PN_MD_XbbVsQCD >u && sdm_Higher_PN_MD_XbbVsQCD<End)) && Higher_PN_MD_XbbVsQCD>PN_scores.at(iPN) && Higher_PN_MD_XbbVsQCD<=PN_scores.at(iPN+1)){
	PN_Data[iPN]->Fill(sdm_Higher_PN_MD_XbbVsQCD/s);
      }
    } 

    for(int iPN=0; iPN<DDX_DIM;iPN++){
      if(sdm_Higher_DDX_XbbVsQCD>l && sdm_Higher_DDX_XbbVsQCD<u && DDX_XbbVsQCD>DDX_scores.at(iPN) && DDX_XbbVsQCD<=DDX_scores.at(iPN+1)){
	DDX_Data_s[iPN]->Fill(sdm_Higher_DDX_XbbVsQCD/s);
      }
      if(((sdm_Higher_DDX_XbbVsQCD>Start && sdm_Higher_DDX_XbbVsQCD<l) || (sdm_Higher_DDX_XbbVsQCD >u && sdm_Higher_DDX_XbbVsQCD<End)) && Higher_DDX_XbbVsQCD>DDX_scores.at(iPN) && Higher_DDX_XbbVsQCD<=DDX_scores.at(iPN+1)){
