...
void Rebinning(){
  ...
  for(int i=0; i<PN_DIM;i++){
    ...
    PN_Data[i]->GetXaxis()->SetTitle("m_{SD} [GeV]");
  ...
  TString fname1= "./Plots/Data_large_msd_range_"+std::to_string(2*rebinning.at(ir))+"GeV.pdf";
