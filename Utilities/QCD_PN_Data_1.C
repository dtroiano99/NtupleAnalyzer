...
{{4,4,1},//indexes of polynomials
    {4,4,1}, //indexes of Cebysev polynomials
      {2,2,1}/*, //indexes of DF
...
void QCD_PN_Data_1(){
  ...
  TString fname= "./Plots/comparison_PN_1.pdf";
  ...
  for(int j=0; j<functions.size();j++){
    ...
    for(int i=0;i<PN_DIM;i++){   
      ...
      std::string filestring{"./rootfiles_1/PN_"+ functions.at(j)+".root"};
